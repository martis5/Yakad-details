...
import {Main, AppBar, Spacer, Button, Footer, Container, Row} from "@yakad/ui"
...
export default function Home() {
  return (
   ...
   <Footer>
    <Spacer/>
  <Button variant="link">
    <a href="https://github.com/NatiqQuran/yakad" style={{display:"flex",alignItems:"center"}}>github
